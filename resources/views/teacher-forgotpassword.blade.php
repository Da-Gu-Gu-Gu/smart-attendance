  ...
  <div style="position: relative;height:70vh;" class="container">
    <div class="row col-12" style="position: absolute;top:50%;left:0;transform:translateY(-50%);" >
            ...
            <h3 class="mt-5  "><span>Don't worry !,</span><br>
                just enter Teacher-ID</h3>  
                <form method="POST" id="tforgetpassword">
                    @csrf
                    ...
                    <div class="text_field mt-5">
                        <input type="text" class="form-control  col-lg-6 col-md-8 " id="tid" value="" onchange="this.setAttribute('value',this.value)">
                        <label for="name" class="col-form-label">Enter teacher-id</label>
...
<script>
    ...
    let aa=document.forms['tforgetpassword'];
    ...
    console.log(tid);
        axios.post('/api/forgetpassord/teacher',{
            'tid':tid
        }).then(res=>{
           ...
           if(res.data.success){
            ...
            if(res.data.tid){
              ...
              error.style.display="block";
                error.innerHTML=res.data.tid[0];
                invalid.style.display="none";
                success.style.display="none";
